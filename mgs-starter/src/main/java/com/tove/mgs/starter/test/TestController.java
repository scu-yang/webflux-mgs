package com.tove.mgs.starter.test;
...
public class TestController {
	...
	// 测试登录接口 [同步模式]， 浏览器访问： http://localhost:8082/test/login
	@GetMapping("login")
	...
	// API测试 [同步模式]， 浏览器访问： http://localhost:8082/test/isLogin
	...
	// API测试 [异步模式]， 浏览器访问： http://localhost:8082/test/isLogin2
	...
	// API测试 [异步模式, 同一线程]， 浏览器访问： http://localhost:8082/test/isLogin3
	...
	// API测试 [异步模式, 不同线程]， 浏览器访问： http://localhost:8082/test/isLogin4
